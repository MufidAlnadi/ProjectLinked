  ...
  return (
    ...
    >
      <div className="container mx-auto">
        <div className="max-w p-6 mb-8 ti:mx-6 bg-[#3b71ca] border border-gray-200 rounded-lg shadow">
          ...
          <div className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-800 rounded-lg hover:bg-blue-900 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            Learn more
            <svg
              aria-hidden="true"
